          ...
          <div className="shadow-md bg-white mt-5 rounded-lg p-5 lg:p-7">
            ...
            <div className="mt-4 text-center text-xs+">
              <p className="line-clamp-1">
                ...
                <Link to={SCREENS.REGISTER} className="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">Create account</Link>
              </p>
            </div>
